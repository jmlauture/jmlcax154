...
# Output Explanation:
# - The logical operators (and, or, not) work with boolean values and return True or False based on the logic of the inputs.
# - The bitwise operators (&, |, ^, ~, <<, >>) work with the binary representation of integers, 
# performing operations on each corresponding bit. 
# The results can be interpreted as new integers, and the binary output helps visualize how the bits are manipulated.         
